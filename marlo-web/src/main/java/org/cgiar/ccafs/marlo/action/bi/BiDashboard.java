...
/**
 * This action is responsible for generating the URL of BI for custom Dashboards. The URL is composed of date + security
...
public class BiDashboard extends BaseAction {
